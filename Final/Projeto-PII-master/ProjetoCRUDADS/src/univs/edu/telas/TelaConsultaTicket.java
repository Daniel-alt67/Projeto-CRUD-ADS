 ...
 * @author Akari
 */
public class TelaConsultaTicket extends javax.swing.JFrame {
    
    Ticket ticket = new Ticket();
    TicketDAO dao = new TicketDAO();
    UsuarioAjudado usuario = new UsuarioAjudado(); 
    
    public TelaConsultaTicket(UsuarioAjudado usuario) {
        initComponents();
        atualizarTabela();
    ...
    public void atualizarTabela(){
        TicketTableModel tm = new TicketTableModel(dao.pesquisar("usuario.idUsuario", UsuarioAjudado.usuario.getIdUsuario()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaTicket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaTicket(null).setVisible(true);
            }
        });
    }
